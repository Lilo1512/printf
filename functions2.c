...
/**
 * get_ptr - Prints the value of a pointer variable
...
/**
 * get_non_printable - Prints ascii codes in hexa of non printable chars
...
/**
 * get_reverse - Prints reverse string.
 * @args: Lista of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width
...
/**
 * get_rot13string - Print a string in rot13.
 * @args: Lista of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width
